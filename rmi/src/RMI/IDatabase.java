...
/*
 * A base de dados deve armazenar o conteúdo da matriz no arquivo informado.
 * Além disso, deve recuperar a matriz quando for solicitado. Por fim, a base de
 * dados deve remover o arquivo quando solicitado.
 */
